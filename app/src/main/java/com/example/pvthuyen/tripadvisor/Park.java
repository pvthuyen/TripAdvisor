...
public class Park extends Place {
    ...
    public Park(String name, String description, String address, String phone, String website, String open_time, String close_time, double lat, double lng) {
        super(name, description, address, phone, website, open_time, close_time, lat, lng);
    }

    public Park(Context context, JSONObject jsonObject) {
        super(context, jsonObject);
        try {
            this.ticketPrice = jsonObject.getInt(Park.TAG_TICKETPRICE);
